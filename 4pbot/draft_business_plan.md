...
The 4Ps, or Pantawid Pamilya Pilipino Program ... _todo: insert from report_


##### Grievances

The grievance redress system (GRS) was designed as a core part of the 4Ps from the start [^2]. It was designed to work at scale, and most of the power in the program seems to be with communities, not at the very top. As with the whole 4Ps, there are multiple levels, from Top, to ___ , municipalities, barangays/villages and households. Grievances from a particular level are addressed by the unit one level above it.

While the GRS is comprehensive, it is not without its drawbacks. Key issues we identified in surveying 4Ps clients were: (1) Clients are afraid to report a grievance, for fear of losing their payout; (2) We saw a power dynamic between clients and municipal link _(is it ML? not sure)_ making it hard for clients to come forward with issues; (3) The existing process requires complicated forms to be filled out, and submitted in person at a Barangay/Village hall - other means of submitting grievances are being used (eg. SMS, Facebook, Twitter), but their reach is limited; and (4) The incentives for grievance officers to resolve grievances are not always aligned with those of the clien - the KPIs of the GRS do not factor in Client satisfaction, but focus on time taken to resolve a grievance and ___ .


##### Oversight, Monitoring, & Evaluation

The 4Ps has existing oversight from both internal and external sources, by way of regular spot checks on the program. Monitoring and Evaluation is also conducted by Civil Sociey Organisations (CSOs) and Nongovernmental Organisations (NGOs), which are built into the framework of DSWD. While these organisations are somewhat separate from the DSWD, most of their funding _TODO: double check this_ still comes within DSWD. We see a need for a completely 3rd party body to be performing monitoring and evaluation on the program, to not only deliver insights to the DSWD, but to the World Bank and ADB, who partly fund the 4Ps. _todo: this is a big claim, need to double check facts_
...
We aim to use 4PBot to enable beneficaries to report issues with the program without having to reveal their identity. Doing so would capture reports that are currently going un reported. By allowing clients to follow up their report with the existing GRS channels, 4PBot also aims to streamline the process for reports, by pre filling forms, and giving tips for the client to follow up their case.

The fear of losing payments when making complaints is not unfounded. By 2014, 0.6% of total active households had been delisted after being found ineligible or to have submitted frafulent information after filing a grievance report. We found reports of the Grievance office allowing for anonymous reports over SMS, but am not too sure about this.

4Pbot can be used to make the GRS more user friendly. Existing channels for reporting greivances over mobile phone require clunky text message conversations, or airtime (pay for data). 4PBot offers a superiour, conversational user experience, and works over Facebook free data. 4PBot will also support SMS and IVR features, opening it up to use by clients who are illiterate, or don't have access to a smartphone or data coverage.

Forms still seem to be the preferred method of filing grievances. While there have been efforts since 2015 to make filing forms easier, such as more local languages, and making them available in more locations, 4Pbot can streamline this process even further. Moreover, face to face reporting is not suitable for other types of reports, such as staff behaviour, or reports of favouritism between a ML and beneficary. 4PBot is well equipped to capture this information, and feed it back to DSWD to address as needed.

We have seen large communities of 4ps clients (>20,000) connecting together in informal Facebook groups, supporting one another, asking questions and recieving advice. Instead of competing with these existing communities 4Pbot can leverage them to allow users to get advice or help with their problems without having to reveal their identity. 4PBot can help communities to partner together with DSWD to improve the program, as well as improve information dissemenation, which will lead to greater accountablity.

### Marketplace

The clearest case for a customer is the DSWD itself. 4PBot could run as a service offered for free to 4Ps client, supported by selling data and insights to the DSWD. Another eligible customer could be the ADB or World Bank, who may be interested in the monitoring and evaluation capacities of 4PBot.

Another possible monetisation strategy would be to build tools and services on top of 4PBot. 4PBot could deliver other financial tools and services to 4Ps clients or other underserved groups.
